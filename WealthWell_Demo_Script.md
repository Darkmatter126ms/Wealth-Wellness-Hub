...
To take a step further towards global use of this app, we do not want to introduce the languages available based on recognised languages in Singapore as most Fintech apps in Singapore is in English and sometimes offer an option in Chinese. Hence together with English, Chinese, we also offer the app in Hindi, Spanish and French to penetrate markets in Europe, Africa, and the Americas as these languages are the five most commonly spoken ones aimed reach out to roughly over 3.4 billion people over the world, removing the language barrier for about 2 in 5 people.
